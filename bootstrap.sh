...
cd /home/ubuntu/bin
sudo -u ubuntu wget -q "https://github.com/visit-dav/visit/releases/download/v3.3.0/visit3_3_0.linux-x86_64-ubuntu20.tar.gz"
sudo -u ubuntu tar xf visit*.tar.gz
sudo -u ubuntu rm visit3*.tar.gz
fi
